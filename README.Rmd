...
... the Sample size column should correspond to the total sample size. The number of cases and the number of controls can also be provided (instead of the total sample size): 
