...
:information\_source: `MRlap` has been updated to version 0.0.3. Note that in previous versions the exclusion of IVs more strong associated with the outcome than with the exposure was not correcltly performed.           
