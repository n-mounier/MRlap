...
This package builds up on the [`GenomicSEM`](https://github.com/GenomicSEM/GenomicSEM/) R-package to perform cross-trait LD-score regression (LDSC) and the [`TwoSampleMR`]() R-package for inverse-variance weighted (IVW-)MR analysis (and instruments pruning).
