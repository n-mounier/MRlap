...
:information\_source: This branch aim at performing serial analyses for the same pair of traits, re-using LDSC results from previous analysis (`LDSC_results`) to speed up analyses. This should be used with care.        
