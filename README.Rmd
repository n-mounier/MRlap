...
\hspace{1cm} SNP-identifier:  `rs` or `rsid`, `snp`, `snpid`, `rnpid`      
...
... the Sample size column should correspond to the effective sample size (not the total sample size). The number of cases and the number of controls can also be provided (instead or in addition to the effective sample size): 
